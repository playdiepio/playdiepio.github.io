document.addEventListener("DOMContentLoaded", () => {
  ...
  const gameDetails = {
    ...
    "Diep.io Unblocked": {
      image: "images/diep-io-icon.jpeg", // Changed from diep-io.png
      url: "https://diep.io/", // Official Diep.io URL
      description: "Upgrade your tank and dominate the arena in this classic multiplayer shooter.",
      genre: "ActionGame",
      keywords: "diep.io, unblocked, tank, multiplayer, shooter, io game",
    },
  }
  ...
  if (playNowBtn) {
    playNowBtn.addEventListener("click", () => {
      ...
      const mainGameUrl = gameDetails["Diep.io Unblocked"].url || "https://play.wgplayground.com/ifr/placeholder"
