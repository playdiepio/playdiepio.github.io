document.addEventListener("DOMContentLoaded", () => {
  ...
  const gameCategories = {
    ...
    arcade: [
      ...
      "Diep.io Unblocked", // Changed from Piano Tiles 2 Unblocked
    ],
    casual: [
      "Tag Unblocked",
      "Among Us Unblocked",
  ...
  const gameImages = {
    ...
    "Diep.io Unblocked": "../images/diep-io-icon.jpeg", // Changed from diep-io.png
  }
  ...
  const gameURLs = {
    ...
    "Hills Of Stell": "https://iframe.unblocked-76-games.org/hills-of-steel-main",
    ...
    "Flappy Bird Unblocked": "https://flappybirdgame.github.io/file/",
    ...
    "OvO Unblocked": "https://unblocked-ovo.github.io/game/",
    "Diep.io Unblocked": "https://diep.io/", // Changed from Piano Tiles 2 Unblocked
  }
  ...
  if (gameTitle) {
    ...
    document.title = `Play ${gameName} - Diep.io` // Updated branding
  }
  ...
  function createHotGameCard(game) {
    ...
    // Redirect Diep.io Unblocked to the homepage
    if (game === "Diep.io Unblocked") {
